class Reports::CompletedAssetCyclesController < ApplicationController
=begin
...
# **********************************
	def index    
		respond_to do |format|		
		  	...
		  	format.json { 		  						
				render json: JqxConverter.jqxGrid(current_user.entity.visible_asset_cycle_facts.where(cycle_complete: 1))
			}
		end
	end 
