class Trash::ProductionPartnershipsController < ApplicationController
  ...
  def index    		
    respond_to do |format|
      ...
      format.json {      		
	      @records = JqxConverter.jqxGrid(current_user.entity.production_partnerships.where(record_status: 0))
      	render json: @records
      }
    end
  end
